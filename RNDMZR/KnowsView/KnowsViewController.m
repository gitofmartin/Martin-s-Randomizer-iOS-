...
@interface KnowsViewController ()

@end

@implementation KnowsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.knowButton.enabled=false;
    PFQuery* query = [PFQuery queryWithClassName:@"knows"];
